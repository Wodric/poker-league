...
public class LegalFee implements Serializable {
	...
	/**
	 *  constructor with mandatory fields without auto-generated id which will be generated by at database commmit
	 * @param shortName fee short name
	 * @param description Description of fee
	 */
	public LegalFee(String shortName, String description) {
		this.shortName = shortName;
		this.description = description;
	}
	...
	/**
	 * constructor with all fields without auto-generated id which will be generated by at database commmit
	 * @param shortName fee short name
	 * @param description Description of fee
	 * @param feePourcent  This variable allow to set a taxe as pourcent
	 * @param feeFixed This variable allow to set a taxe as fixes fee
	 * @param tournaments The tournament which use the fee
	 */
	public LegalFee(String shortName, String description, Integer feePourcent, Integer feeFixed,
			Set<Tournament> tournaments) {
		this.shortName = shortName;
		this.description = description;
		this.feePourcent = feePourcent;
	...
	public void addTournaments(Set<Tournament> tournaments) {
